...
uconv0_BA = BatchActivate(uconv0)
uconv0_1 = block(uconv0_BA, 16, 8)
uconv0_add_1 = Add()([uconv0, uconv0_1])

uconv0_add_1_BA = BatchActivate(uconv0_add_1)
